...
// display main menu and user inputs
function init() {
  inquirer.prompt([
    {
      type: 'list',
  ...
  //user inputs, run coresponding function 
...
//shows the roles of the employee
...
function addDepartment() {
  inquirer.prompt(
    ...
    .then(response => {
      db.query("INSERT INTO department(name) values (?)", [response.department], function (_err, results) {
...
function addRole() {
  db.query("SELECT id as value, name as name FROM department", function (_err, results) {
    inquirer.prompt([{
      type: "input",
      name: "role",
...
function addEmployee() {
  db.query("SELECT id as value, title as name FROM role", function (_err, results) {
    const roles = results;
